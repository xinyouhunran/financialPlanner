<template>
	<view class="l-container">
		...
		<view class="l-body-view l-body-view-1">
			<video class="l-video" @play="onPlay"
			:src="dataInfo.videoUrl" controls>
				<cover-image @tap="$back()" class="l-img-back" src="../../static/backwhite@2x.png"></cover-image>
			</video>
		</view>
				...
				<scroll-view scroll-y="true"  class="l-scroll">
					<view class="swiper-item">
						...
						<view class="l-body-view l-body-view-4">
							<view class="l-bv4-item" @tap="$nav({ url: '/pages/company-details/company-details?id=' + dataInfo.orgId })">
								<view class="l-siv-avatar l-siv-avatar-company">
									<image class="l-siv-img" src="../../static/picture.png" mode="aspectFill"></image>
								</view>
						...
						<view class="l-body-view l-body-view-3 l-body-text">
							...
							<view class="l-bv-body " :class="{ 'l-txt-overflow8': dataInfo.isDetail }">
								{{ dataInfo.detail }}
							</view>
				...
				_this.$get(url, params)
					.then(res => {
						if (res.code == 200) {
							...
							if(info.detail && info.detail.length > 200){
								info.isDetail = true;
							}
							if(info.presenterIntroduce && info.presenterIntroduce.length > 200){
