<template>
	<view class="l-container" v-if="!0">
		...
		<view class="add-head l-bb">
			<view class="l-flex name">
				<view class="">
		...
		<view class="add-middle l-view">
			<view class="l">
				<view class="colore70012">
					76.91%
				</view>
				<view class="">
					日涨跌
...
<script>
	...
	export default {
		...
		onLoad(e) {
			this.id = e.id || this.$productId ||'40005784';
